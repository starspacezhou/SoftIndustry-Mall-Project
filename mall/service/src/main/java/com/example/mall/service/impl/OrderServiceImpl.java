...
import com.example.mall.dao.OrdersMapper;
import com.example.mall.dao.ProductSkuMapper;
...
import com.example.mall.utils.PageHelper;
...
public class OrderServiceImpl implements OrderService {
    ...
    public Map<String, String> addOrder(String cids, Orders order) throws SQLException {
        ...
        for (ShoppingCartVO sc : list) {
            ...
            //获取所有商品名称，以,分割拼接成字符串
            order_name = order_name + sc.getProductName() + ",";
        }
        ...
        if (flag) {
            ...
            map.put("productNames", order_name);
            return map;
        } else {
            //表示库存不足
            return null;
